...
```
```{r scraping population ethnicity table, include=FALSE}
...
```{r download census data w scraper, results='hide', include=FALSE}
...
```{r spatial census and stop and search, results='hide', include=FALSE}
...
```{r statistical analysis part 1, results= 'hide', include=FALSE}
